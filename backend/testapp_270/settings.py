"""
Django settings for testapp_270 project.
...
WSGI_APPLICATION = 'testapp_270.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp_270 API",
    "DESCRIPTION": "API documentation for testapp_270 App",
    "VERSION": "v1",
}
